...
export const profile: Profile = {
  ...
  about: [
    ...
    "Na Overload, desenvolvo serviços de backend em TypeScript e Python, integro plataformas externas via API e estruturo dados em PostgreSQL. Curso Bacharelado em Ciência da Computação na Universidade de Vila Velha, e trabalho com C# e Java em projetos próprios e certificações.",
  ],
  highlights: [
